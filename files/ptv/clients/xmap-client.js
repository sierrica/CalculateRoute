...
function XMapClient(requestURL, activeRequestLimit) {
	 ...
	 */
	this.renderMap = function (mapSection, mapParams, imageInfo, layers, includeImageInResponse,  callerContext, onResult, timeout) {
		return sendRequest("renderMap", {  mapSection: mapSection, mapParams: mapParams, imageInfo: imageInfo, layers: layers, includeImageInResponse: includeImageInResponse, callerContext: callerContext || client.callerContext }, onResult, timeout || client.renderMap.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.renderMapBoundingBox = function (mapSection, mapParams, imageInfo, layers, includeImageInResponse,  callerContext, onResult, timeout) {
		return sendRequest("renderMapBoundingBox", {  mapSection: mapSection, mapParams: mapParams, imageInfo: imageInfo, layers: layers, includeImageInResponse: includeImageInResponse, callerContext: callerContext || client.callerContext }, onResult, timeout || client.renderMapBoundingBox.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.renderMapRot = function (mapSection, mapParams, imageInfo, layers, includeImageInResponse,  callerContext, onResult, timeout) {
		return sendRequest("renderMapRot", {  mapSection: mapSection, mapParams: mapParams, imageInfo: imageInfo, layers: layers, includeImageInResponse: includeImageInResponse, callerContext: callerContext || client.callerContext }, onResult, timeout || client.renderMapRot.timeout);
	};
