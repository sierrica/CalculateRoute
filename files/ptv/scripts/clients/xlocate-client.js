...
function XLocateClient(requestURL, activeRequestLimit) {
	 ...
	 */
	this.matchAddress = function (addr, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("matchAddress", {  addr: addr, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.matchAddress.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.matchAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("matchAddresses", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.matchAddresses.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.matchLocation = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("matchLocation", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.matchLocation.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.matchLocations = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("matchLocations", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.matchLocations.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findAddress = function (addr, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findAddress", {  addr: addr, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findAddress.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findAddresses", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findAddresses.timeout);
	};
		    	    	/**
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startFindAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("startFindAddresses", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.startFindAddresses.timeout);
	};
	 ...
	 */
	this.runFindAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, watchOptions, onUpdate, retryOptions) {
		return runJob(client.startFindAddresses, [ addrs,  options,  sorting,  additionalFields,  callerContext], client.fetchAddressResponses, onResult, watchOptions, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchAddressResponses = function (id, callerContext, onResult, timeout) {
		return sendRequest("fetchAddressResponses", { id: id, callerContext: callerContext || client.callerContext }, onResult, timeout || client.fetchAddressResponses.timeout);
	};	
			       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findLocation = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findLocation", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findLocation.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findLocations = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findLocations", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findLocations.timeout);
	};
		    	    	/**
	 * Job starter service method. For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startFindLocations = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("startFindLocations", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.startFindLocations.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runFindLocations = function (location, options, sorting, additionalFields,  callerContext, onResult, watchOptions, onUpdate, retryOptions) {
		return runJob(client.startFindLocations, [ location,  options,  sorting,  additionalFields,  callerContext], client.fetchAddressResponses, onResult, watchOptions, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findPoiByAddress = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findPoiByAddress", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findPoiByAddress.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findPoiByAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findPoiByAddresses", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findPoiByAddresses.timeout);
	};
		    	    	/**
	 * Job starter service method. For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startFindPoiByAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("startFindPoiByAddresses", {  addrs: addrs, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.startFindPoiByAddresses.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runFindPoiByAddresses = function (addrs, options, sorting, additionalFields,  callerContext, onResult, watchOptions, onUpdate, retryOptions) {
		return runJob(client.startFindPoiByAddresses, [ addrs,  options,  sorting,  additionalFields,  callerContext], client.fetchPoiAddressResponses, onResult, watchOptions, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.fetchPoiAddressResponses = function (id, callerContext, onResult, timeout) {
		return sendRequest("fetchPoiAddressResponses", { id: id, callerContext: callerContext || client.callerContext }, onResult, timeout || client.fetchPoiAddressResponses.timeout);
	};	
			       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findPoiByLocation = function (location, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findPoiByLocation", {  location: location, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findPoiByLocation.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findPoiByLocations = function (locations, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findPoiByLocations", {  locations: locations, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findPoiByLocations.timeout);
	};
		    	    	/**
	 * Job starter service method. For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.startFindPoiByLocations = function (locations, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("startFindPoiByLocations", {  locations: locations, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.startFindPoiByLocations.timeout);
	};
	 ...
	 * @returns {object} the XMLHttpRequest object used, or null if the active request limit has been reached. 
	 */
	this.runFindPoiByLocations = function (locations, options, sorting, additionalFields,  callerContext, onResult, watchOptions, onUpdate, retryOptions) {
		return runJob(client.startFindPoiByLocations, [ locations,  options,  sorting,  additionalFields,  callerContext], client.fetchPoiAddressResponses, onResult, watchOptions, onUpdate, retryOptions);
	};	
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findAddressByText = function (address, country, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findAddressByText", {  address: address, country: country, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findAddressByText.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findCombinedTransportByLocation = function (location, options, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findCombinedTransportByLocation", {  location: location, options: options, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findCombinedTransportByLocation.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findObjectByText = function (text, country, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findObjectByText", {  text: text, country: country, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findObjectByText.timeout);
	};
	       /**
	 * For the operation itself and its leading parameters please refer to PTV xServer API documentation. 
	 * @param {...*} functionalParameters - please refer to PTV xServer API documentation for functional parameters.
	 ...
	 * @throws {object} only in the synchroneous mode: the error message from the server, or an Error object if a CORS request would be needed for an older IE browser.
	 */
	this.findSuggestion = function (text, country, state, options, sorting, additionalFields,  callerContext, onResult, timeout) {
		return sendRequest("findSuggestion", {  text: text, country: country, state: state, options: options, sorting: sorting, additionalFields: additionalFields, callerContext: callerContext || client.callerContext }, onResult, timeout || client.findSuggestion.timeout);
	};
	     /**
